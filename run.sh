...
#     for j in {1..10}; do
#         output=$(./openMP_implementation < tests/in/test${i}.in)
...
#     echo "Path: ${last_path}" > tests/out_openMP/test${i}.out
#     echo "Minimum cost: ${last_minimum_cost}" >> tests/out_openMP/test${i}.out
#     echo "Mean total time: ${mean_total_time} seconds" >> tests/out_openMP/test${i}.out
...
#     for j in {1..10}; do
#         output=$(./pthread_implementation < tests/in/test${i}.in)
...
#     echo "Path: ${last_path}" > tests/out_pthreads/test${i}.out
#     echo "Minimum cost: ${last_minimum_cost}" >> tests/out_pthreads/test${i}.out
#     echo "Mean total time: ${mean_total_time} seconds" >> tests/out_pthreads/test${i}.out
...
#     for j in {1..10}; do
#         output=$(mpirun -np 24 --oversubscribe mpi_implementation < tests/in/test${i}.in)
...
#     echo "Path: ${last_path}" > tests/out_mpi/test${i}.out
#     echo "Minimum cost: ${last_minimum_cost}" >> tests/out_mpi/test${i}.out
#     echo "Mean total time: ${mean_total_time} seconds" >> tests/out_mpi/test${i}.out
